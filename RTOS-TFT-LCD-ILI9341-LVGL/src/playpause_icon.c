...
#ifndef PLAYPAUSE_ICON
#define PLAYPAUSE_ICON 1
#endif
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 112, .adv_w = 448, .box_w = 28, .box_h = 28, .ofs_x = 0, .ofs_y = -2}
};
...
#if LV_VERSION_CHECK(8, 0, 0)
const lv_font_t playpause_icon = {
#else
lv_font_t playpause_icon = {
#endif
